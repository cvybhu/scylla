...
BOOST_AUTO_TEST_CASE(expression_extract_column_restrictions) {
    ...
    expression r1_ck1_restriction = make_multi_column_restriction({&col_r1, &col_ck1}, oper_t::GT);;
    expression conjunction_expr = conjunction{std::vector{ck1_ck2_restriction, r1_ck1_restriction}};
    ...
    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_pk1),
        {pk1_restriction, pk1_pk2_restriction, pk1_ck2_r1_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_pk2),
        {pk2_restriction, pk1_pk2_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_ck1),
        {ck1_restriction, ck1_ck2_restriction, r1_ck1_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_ck2),
        {ck2_restriction, pk1_ck2_r1_restriction, ck1_ck2_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_r1),
        {r1_restriction, pk1_ck2_r1_restriction, r1_r2_restriction, r1_ck1_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_r2),
        {r2_restriction, r1_r2_restriction});

    assert_expr_vec_eq(extract_column_restrictions(big_where_expr, col_r3),
        {});
}
